...
def GetArgs():
   ...
   parser.add_argument('-sn', '--snapshot', required=False, action='store', help='Snapshot Name')
   parser.add_argument('-v', '--vmname', required=True, action='store', help='Names of the Virtual Machines')
   parser.add_argument('-op', '--operation', required=True, action='store', help='poweron or poweroff')
...
def main():
    ...
    elif operation == 'convertTemplate':
        print("Converting %s to template" % vm.name)
        vm.MarkAsTemplate()
