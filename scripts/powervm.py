...
def GetArgs():
   ...
   parser.add_argument('-v', '--vmname', required=True, action='append', help='Names of the Virtual Machines')
   parser.add_argument('-c', '--cycle', required=True, action='store', help='poweron or poweroff')
...
def main():
   ...
   try:
      ...
      if args.cycle == 'del':
        tasks = [vm.Destroy() for vm in vmList if vm.name in vmnames]
        WaitForTasks(tasks, si)
        print("Virtual Machine(s) have been removed")
